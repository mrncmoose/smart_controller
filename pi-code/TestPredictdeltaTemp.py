...
class Test(unittest.TestCase):
    ...
    def testSecToTemp(self):
        ...
        secsToTemp = uot.secondsToTemp(8.8)
    ...
    def testSecToTempLarger(self):
        uot = PredictDeltaTemp.thermalCalculations
        secsToTemp = uot.secondsToTemp(20)
    ...
    def testdeltaTemp(self):
        ...
        self.assertAlmostEqual(2.70, uot.deltaTemp(1000), 2, 'Incorrect detlaT')

    def testNotDeltaTemp(self):
        uot = PredictDeltaTemp.thermalCalculations
        #~8.8 degrees rise in 5000 seconds.
        self.assertNotAlmostEqual(2.70, uot.deltaTemp(5000), 2, 'Incorrect detlaT')
